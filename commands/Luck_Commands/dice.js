...
module.exports = {
 ...
 //   if(message.deletable) message.delete()
  ...
  .setColor('RANDOM')
  .setDescription(`You Rolled A \`\`${args[0]}\`\`, The Dice Was \`\`${result}\`\`\nYou Won: ${newbalance.toLocaleString()}\nYou Now Have: ${check.cash.toLocaleString() + newbalance.LocaleString()}`)
  ...
  message.reply(embed)
    ...
    .setColor('RANDOM')
    .setDescription(`You Rolled A \`\`${args[0]}\`\`, The Dice Was \`\`${result}\`\`\nYou Now Have: ${check.cash.toLocaleString() - newbalance.toLocaleString()}`)
